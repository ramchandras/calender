...
var main = createPlugin({
    ...
    views: {
        timeGrid: {
            ...
            columnHeaderHtml: function(date) {
              ...
              if (date.getDay() === 1) {
                return '<b>周一 '+mon+'-'+day+'</b>';
              } else if (date.getDay() === 2){
                return '<b>周二 '+mon+'-'+day+'</b>';
              }else if (date.getDay() === 3){
                return '<b>周三 '+mon+'-'+day+'</b>';
              }else if (date.getDay() === 4){
                return '<b>周四 '+mon+'-'+day+'</b>';
              }else if (date.getDay() === 5){
                return '<b>周五 '+mon+'-'+day+'</b>';
              }else if (date.getDay() === 6){
                return '<b>周六 '+mon+'-'+day+'</b>';
              }else if (date.getDay() === 0){
                return '<b>周日 '+mon+'-'+day+'</b>';
              }
            },
    ...
    //   var state='新建预约';
    //   var start =selectionInfo.startDate.format('YYYY-MM-DD HH:mm');
    //   var end =selectionInfo.endDate.format('YYYY-MM-DD HH:mm');
    //   var docName;
    //   if(view.type=='agendaDay'){
    //     docName=selectionInfo.resource.title;
    //   }else{
    //     docName='';
    //   }
